 ...
 * carry `onSubmit`. It owns the interaction and nothing else: the stored values
 ...
 *
 * Deliberately close to `../new/new-workout-form.tsx` rather than factored out
 * of it: docs/data-mutation.md §1 puts the shared part in `src/data/`, and the
 * two screens are free to diverge (defaults vs. stored values, wording, the
 * fields each one exposes).
 */
    ...
    <form onSubmit={handleSubmit}>
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Changes apply to the whole session — the weight unit re-reads every
            set already logged against it.
          </CardDescription>
        </CardHeader>
        ...
        <CardContent className="flex flex-col gap-6">
          ...
          <div className="flex flex-col gap-2">
            ...
            <p className="text-xs text-muted-foreground">
              Applies to every set logged in this session. Changing it relabels
              the weights; it does not convert them.
            </p>
          </div>
